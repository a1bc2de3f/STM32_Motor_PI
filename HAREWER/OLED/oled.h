...
#define OLED_SCL_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_13)//SCL
#define OLED_SCL_Set() GPIO_SetBits(GPIOC,GPIO_Pin_13)

#define OLED_SDA_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_14)//DIN
